    ...
    */
    ...
    setupDefaults = function() {
      ...
      this.options = $.extend({
        ...
        debug: false,
        swipeThreshold: 10,
        frame: dirSample + '26.png',
        frameSize: [{width: 400, minScreenWidth: 800},
          {width: 300, maxScreenWidth: 700, minScreenWidth: 768},
          {width: 200, maxScreenWidth: 567}],
        boundingBox: {
          left: '15.3%',
          top: '12.48%',
          width: '69.4%',
        ...
        images: (function(){ return [11,21,11].map(function(n){ return dirSample + n + '.png'; }); })(),
        controlsPosition: {
          top: '35%'        
        },
        autoplay: true,
